        ...
        >
          <div className="card-container">
            <div className="create-content">
                ...
                <>
                  {page_data.current_repo_id_selected !== null && (
                    <p>
                      ...
                      <b>{page_data.current_repo_id_selected}</b> selected for
                      this Stack.
                    </p>
                  )}
                  {page_data.current_repo_id_selected === null && (
                    <>
                      {page_data.repo_select_list === "too_many_requests" && (
                        <p>
                          Too many requests to the GitHub API at this moment.
                        </p>
                      )}
                      {page_data.repo_select_list !== "too_many_requests" && (
                        <>
                          <p>
                            Select GitHub repo you would like to associate with
                            this Stack.
                          </p>
              ...
              {page_data.saved_stack_data?.databasesSelectedData !== null && (
                <>
                  <img
